...
export const world = (() => {
  ...
  class WorldObject {
    ...
    LoadModel_() {
      ...
      loader.load('./src/models/mark22.fbx', (fbx) => {
  ...
  class WorldManager {
    ...
    SpawnObj_(scale, offset) {
      ...
      obj.quaternion.setFromAxisAngle(new THREE.Vector3(0, 1, 0), Math.PI);
      obj.position.x = START_POS + offset + 5;
      obj.position.z = 1 * math.rand_range(1, 20);
      obj.scale = 0.0026;
